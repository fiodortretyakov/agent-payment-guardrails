...
export const PaymentIntentSchema = z.object({
  idempotencyKey: z.string().min(1).describe('Unique key to prevent duplicate payments'),
  goal: z.string().min(5).describe("The high-level objective provided to the agent"),
